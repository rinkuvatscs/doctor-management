...
import com.medical.solutions.constants.PatientLoginQueryConstants;
import com.medical.solutions.dao.PatientLoginDao;
import com.medical.solutions.entity.PatientLogin;
import com.medical.solutions.extractor.PatientLoginExtractor;
...
public class PatientLoginDaoImpl implements PatientLoginDao {
	...
	public String validateLogin(PatientLogin patientLogin) {
		...
		StringBuffer query = new StringBuffer(
				PatientLoginQueryConstants.IS_EXIST);
		...
		List<PatientLogin> response = jdbcTemplate.query(query.toString(),
				new PatientLoginExtractor(), args.toArray());
	...
	private boolean isExist(PatientLogin patientLogin) {
		...
		if (!StringUtils.isEmpty(patientLogin)
			...
			List<PatientLogin> responseExist = jdbcTemplate.query(
					query.toString(), new PatientLoginExtractor(), args);
