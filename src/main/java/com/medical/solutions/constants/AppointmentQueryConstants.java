...
public interface AppointmentQueryConstants {
	...
	String GET_APPOINTMENT_BY_PID = " SELECT APP.appointmentId, APP.pId, APP.dId, APP.appointmentDate, APP.appointmentDesc, APP.createdDate, DOC.name, DOC.mobile, DOC.email, "
			+ "DOC.gender, DOC.dob, DOC.profilePicPath from u754709029_doc.appointment AS APP INNER JOIN u754709029_doc.doctor AS DOC ON "
			+ "APP.dId = DOC.dId WHERE APP.pId = ? ";
