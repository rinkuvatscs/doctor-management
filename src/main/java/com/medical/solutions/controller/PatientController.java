...
import com.medical.solutions.response.PatientResponse;
import com.medical.solutions.service.PatientService;
...
public class PatientController {
	...
	public PatientResponse addPatient(@RequestBody Patient patient) {
		...
		if (!StringUtils.isEmpty(patient)
				&& !StringUtils.isEmpty(patient.getAdhaar())
	...
	public Integer patientSignUp(@RequestBody Patient patient) {
		if (!StringUtils.isEmpty(patient)
			...
			throw new BadRequestException(
					"Patient SignUp details should not be blank");
		}
	}
